...
final class CreateNewArtistViewController: UIViewController {
    ...
    @objc private func saveNewArtist() {
        ...
        let newArtist = Artist(
            ...
            image: "Aivazovsky",
            works: [Work(title: "Девятый вал", image: "Aivazovsky1", info: "Одна из самых знаменитых картин русского художника-мариниста Ивана Айвазовского, хранится в Русском музее в Санкт-Петербурге (инв. Ж-2202). Написана в 1850 году."),
                    Work(title: "Чесменский бой", image: "Aivazovsky2", info: "Картина наглядно описывает вторую фазу морского сражения между русскими и турецкими флотами — прорыв русских кораблей в Чесменскую бухту в ночь на 26 июня (7 июля) 1770 года и уничтожение брандерами и артиллерийским огнём стоявшего в ней на якоре турецкого флота."),
                    Work(title: "Гнев морей", image: "Aivazovsky3", info: "Изображено штормовое море вблизи скал, очертания которых теряются во мраке. Бушующее море сливается с грозовым небом. Из-за тёмных туч сверкают молнии. Волны бьются о высокий берег и стекают по скалам. Атмосфера бури, гнева моря, передана так мощно, что зритель будто слышит грохот волн и раскаты грома.")
                   ]
        )
